...
func TestToolRegistry(t *testing.T) {
	t.Run("register and get tool", func(t *testing.T) {
		...
		registry.Register(NewReadTool("", &ops.RealFileOps{}))
	...
	t.Run("list tools", func(t *testing.T) {
		registry := NewToolRegistry()
		registry.Register(NewReadTool("", &ops.RealFileOps{}))
		registry.Register(NewWriteTool("", &ops.RealFileOps{}))
...
func TestToolDescriptionAndParameters(t *testing.T) {
	tools := []types.Tool{
		NewReadTool("", &ops.RealFileOps{}),
		NewWriteTool("", &ops.RealFileOps{}),
		NewEditTool("", &ops.RealFileOps{}),
		NewBashTool(&ops.RealExecOps{}),
	}
